...
import { onLiquidGlassClick } from "../more/liquidglass";
            ...
            const findTopbarFusionPlus = (searchAttempt: number = 0) => {
                ...
                if (topbarFusionPlus) {
                    ...
                    if (parent) {
                        ...
                        const liquidGlassItem = parent.querySelector<HTMLButtonElement>("#asri-enhance-liquid-glass");
                        if (liquidGlassItem) {
